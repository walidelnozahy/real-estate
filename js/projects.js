$(document).ready(function(){
  ...
  TweenMax.from(".normal-nav",1,{y:-100});
  TweenMax.from(".projects-hero-carousel",2,{opacity:0});
  TweenMax.from(".projects-hero-carousel h1",2,{y:100});
  TweenMax.from(".projects-hero-carousel .projects-filter",2,{y:100});
